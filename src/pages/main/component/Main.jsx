...
<div className={style.main}>
  ...
  <h1 id="schedule">Meeting Schedule</h1>
  <img src="media/time.svg" style={{width: '100%'}} />
  <h1>We meet on Fridays!</h1>
  <p>Here's a rough outline of the first five days:</p>
  ...
  <div className={style.teamCard}>
    ...
    <div className="row">
      ...
      <a href="http://justinwzig.github.io"><h2>Jusitn Ziegelmueller</h2></a>
    </div>
  </div>
</div>
)
